...
export function buildPrompts(): PromptDef[] {
  return [
...

    {
      ...
      description:
        'Generate a 30-60s vertical music video: music + 4-8 image frames + video interpolation per frame + optional TTS narration. Operator-recommended model sequence.',
      argsSchema: {
          ...
          messages: [
            {
              ...
              content: {
                type: 'text',
                text:
                  `Build a ${seconds}s music video using these Medhā tools + the operator's preferred models.\n\n` +
...

    {
      ...
      description:
        'Triple-tool podcast: web research → script via chat → TTS narration. Operator-curated defaults.',
      argsSchema: {
          ...
          messages: [
            {
              ...
              content: {
                type: 'text',
                text:
                  `Produce an ${length}-minute podcast on "${topic}".\n\n` +
...

    {
      ...
      description:
        'Generate a hero poster for a landing page or dashboard: chat-composed prompt → flux-2-pro image → optional upscale.',
      argsSchema: {
          ...
          messages: [
            {
              ...
              content: {
                type: 'text',
                text:
                  `Compose a hero poster for "${subject}".\n\nWorkflow:\n\n` +
...

    {
      ...
      description:
        'Build a persistent role-play character: persona prompt + reference avatar image + voice clone manifest. Save into a single JSON profile for re-use.',
      argsSchema: {
          ...
          messages: [
            {
              ...
              content: {
                type: 'text',
                text:
                  `Build a persistent character profile named "${name}" (archetype: ${archetype}).\n\nWorkflow:\n\n` +
